                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div class="col-span-1 md:col-span-3">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                            <a href="/pages/job-details.php" title="Health, and Safety Manger Contract / Freelance Leicester" aria-label="Health, and Safety Manger Contract / Freelance Leicester" class="p-5 border border-brand-white rounded group flex flex-col">
